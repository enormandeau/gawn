...
GENOME_NAME="test_genome.fasta"                  # Name of genome fasta file found in 03_data
TRANSCRIPTOME_NAME="test_transcriptome.fasta"    # Name of transcriptome fasta file found in 03_data
